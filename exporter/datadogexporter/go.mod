...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/metadataproviders v0.111.0
...
require github.com/open-telemetry/opentelemetry-collector-contrib/pkg/datadog v0.111.0
