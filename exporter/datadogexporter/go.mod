...
require (
	...
	github.com/DataDog/datadog-agent/comp/core/hostname/hostnameinterface v0.57.0
	github.com/DataDog/datadog-agent/comp/core/log v0.56.2
	github.com/DataDog/datadog-agent/comp/logs/agent/config v0.57.0
	github.com/DataDog/datadog-agent/comp/otelcol/logsagentpipeline v0.57.0
	github.com/DataDog/datadog-agent/comp/otelcol/logsagentpipeline/logsagentpipelineimpl v0.57.0
	...
	github.com/DataDog/datadog-agent/pkg/logs/sources v0.57.0
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/connector/datadogconnector v0.109.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/ecsutil v0.109.0
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/metadataproviders v0.109.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/resourcetotelemetry v0.109.0
	...
	go.opentelemetry.io/collector/config/configcompression v1.15.1-0.20240911162712-6c2697c4453c
	go.opentelemetry.io/collector/config/confighttp v0.109.1-0.20240911162712-6c2697c4453c
	go.opentelemetry.io/collector/config/confignet v0.109.1-0.20240911162712-6c2697c4453c
	...
	go.opentelemetry.io/collector/featuregate v1.15.1-0.20240911162712-6c2697c4453c
...
require github.com/open-telemetry/opentelemetry-collector-contrib/pkg/datadog v0.0.0-00010101000000-000000000000
...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/docker v0.109.0 // indirect
	...
	go.opentelemetry.io/collector/filter v0.109.1-0.20240911162712-6c2697c4453c // indirect
