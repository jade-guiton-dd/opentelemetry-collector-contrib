...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/sqlquery v0.109.0
...
require (
	...
	go.opentelemetry.io/collector/extension/experimental/storage v0.109.1-0.20240911162712-6c2697c4453c
)
