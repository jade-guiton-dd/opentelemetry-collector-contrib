...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/k8stest v0.109.0
	github.com/stretchr/testify v1.9.0
	go.opentelemetry.io/collector/client v1.15.1-0.20240911162712-6c2697c4453c
